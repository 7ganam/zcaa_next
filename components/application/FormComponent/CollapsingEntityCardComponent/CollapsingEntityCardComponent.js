                            ...
                            <Row className="justify-content-start mt-2">
                                <Col lg="8" className="pr-lg-1 px-2">
                                    ...
                                    <div className="form-group mb-1" style={{ width: "100%" }}>
                                        ...
                                        {props.entities &&
                                            <Field name={`entities[${index}].entity_name`} as="select" className="form-control in_field"  >
                                                {({ form, field }) => {
                        ...
                        <Container row>
                            <Row>
                                        ...
                                        {({ form, field }) => {
                                            ...
                                            return (
                                                <CountryDropdown
                                                    ...
                                                    onBlur={
                                                        val => setFieldTouched(`entities[${index}].country`)
                                                    }
                                                    onChange={val => { setFieldValue(`entities[${index}].country`, val) }} />
                                            )
                                        }}
                                    </Field>
                                ...
                                <Col sm={9}>
                                    ...
                                    <Field name={`entities[${index}].region`} className="form-control in_field" >
                                        {({ form, field }) => {
                                            const { setFieldValue } = form
                                            const value = field.value
                                            return (
                                                <RegionDropdown
                                                    ...
                                                    onChange={val => setFieldValue(`entities[${index}].region`, val)} />
                                            )
                                        }}
                                    </Field>
                                ...
                                <Col sm={9}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'row', width: "100%" }}>
                                        ...
                                        <Button
                                            color={Iscurrent ? "success" : "secondary"} onClick={toggle_current}
                                            style={{ width: Iscurrent ? '100%' : '100px', transition: 'width 1s', marginLeft: 'auto' }}
                                        >current</Button>
                                    </div>
                                </Col>
