              ...
              <Row className="justify-content-start mt-2">
                <Col lg="8" className="pr-lg-1 px-2">
                  <div className="form-group mb-1" style={{ width: "100%" }}>
                    ...
                    >
                      {`university ${index + 1} name`}{" "}
                    </label>
                    {props.unies && (
                      <Field
                        name={`universities[${index}].uni_name`}
                        as="select"
                        ...
                        {({ form, field }) => {
                          ...
                          return (
                            <CreatableSelect
                              ...
                              defaultInputValue={
                                form.values.universities[index].uni_ref &&
                                form.values.universities[index].uni_ref[0].name
                              }
                              onChange={(newValue, actionMeta) => {
                                setFieldValue(
                                  `universities[${index}].uni_name`,
                                  newValue
                                );
                ...
                <Col lg="4" className="pl-lg-1 px-2">
                  <div className="form-group mb-1" style={{ width: "100%" }}>
                    <label
                      htmlFor={`universities[${index}].visit_type`}
                      className="form_text mb-1"
                    >
                      {" "}
                      visit type{" "}
                    ...
                    <Field
                      name={`universities[${index}].visit_type`}
                      as="select"
            ...
            <Container row>
              <Row>
                ...
                <Col sm={9}>
                  ...
                  <Field
                    name={`universities[${index}].grad_date`}
                    className="form-control in_field"
                  >
                    {({ form, field }) => {
                      const { setFieldValue } = form;
                ...
                <Col sm={3} className="d-flex justify-content-md-end pr-0">
                  <div
                    htmlFor={`universities[${index}].country`}
                    className="card_body_labels mb-1"
                  >
                    country
                  </div>
                    ...
                    {({ form, field }) => {
                      ...
                      return (
                        <CountryDropdown
                          ...
                          onBlur={(val) =>
                            setFieldTouched(`universities[${index}].country`)
                          }
                          onChange={(val) => {
                            setFieldValue(
                ...
                <Col sm={9}>
                  <Field
                    name={`universities[${index}].region`}
                    className="form-control in_field"
                  >
                    {({ form, field }) => {
                      const { setFieldValue } = form;
                      ...
                      return (
                        <RegionDropdown
                          ...
                          onChange={(val) =>
                            setFieldValue(`universities[${index}].region`, val)
                          }
                        />
                      );
                    }}
                ...
                <Col sm={3} className="d-flex justify-content-md-end pr-0">
                  <div
                    htmlFor={`universities[${index}].linkedin`}
                    className="card_body_labels mb-1"
                  >
                ...
                <Col sm={9}>
                  <Field
                    name={`universities[${index}].linkedin`}
                    className="form-control in_field"
                  >
                    {/* <Field name={`university_${index}`} className="form-control in_field" > */}
                  </Field>
