  ...
  useEffect(() => {
    setTimeout(() => {
      const fetched_members = [
        ...
        {
          name: "Mahmoud Abdelhay",
          image:
            "https://zcaa-bucket2.s3.eu-central-1.amazonaws.com/Mahmoud_Radwan.jpg",
          role: "Vice President",
        },

        {
          name: "Mohamed Askar",
          image:
            "https://zcaa-bucket2.s3.eu-central-1.amazonaws.com/240255407_1471363716572724_7643733241861387229_n.jpg",
          role: "Financial Vice",
        },

        {
          ...
          role: "Membership Committee Head",
        },

        {
          ...
          role: "Legislation Committee Head",
        },

        {
          name: "Mohammed Hatem",
          image: "https://zcaa-bucket2.s3.eu-central-1.amazonaws.com/hatem.jpg",
          role: "HR Committee Head",
        },

        {
          name: "Mustafa Nasr",
          image:
            "https://zcaa-bucket2.s3.eu-central-1.amazonaws.com/Mostafa+Nasr.jpeg",
          role: "Communication Committee Head",
        },

        {
          name: "Toka Hussein",
          image:
            "https://zcaa-bucket2.s3.eu-central-1.amazonaws.com/Toka+Hussein.jpg",
          role: "Activities Committee Head",
        },

        {
          name: "Mahmoud Hamamo",
          image:
            "https://zcaa-bucket2.s3.eu-central-1.amazonaws.com/IMG_Hamamou.jpg",
          role: "Services Committee Head",
        },
      ];
